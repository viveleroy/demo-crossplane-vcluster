...
helm install --repo https://argoproj.github.io/argo-helm --create-namespace --namespace argocd argocd argo-cd --version 7.6.12  --set "configs.cm.application\.resourceTrackingMethod=annotation" --wait
